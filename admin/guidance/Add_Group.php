...
<main class="app-content">
	...
	<div class="col-md-12">
		<div class="col-md-12">
			<div class="tile">
				<h3 class="tile-title">Tag a Group</h3>
							...
							<div class="tile-footer">
								<div class="row">
									<div class="col-md-8 col-md-offset-3">
										<button class="btn btn-primary" type="button"  onclick="ExportToTable()" name="add_subjectDetail" id="add"><i class="fa fa-fw fa-lg fa-check-circle"></i>Save</button>&nbsp;&nbsp;&nbsp;<a class="btn btn-secondary" href="Student.php"><i class="fa fa-fw fa-lg fa-arrow-circle-o-left"></i>Back</a>&nbsp;&nbsp;&nbsp;
									</div>
											...
											if (exceljson.length > 0 && cnt == 0) {    
												exceljson.forEach(element => {
													$.ajax({
														...
														data: {student: JSON.stringify(element)},
														dataType: 'json'
												})
												.done( function( data ) {
														console.log('done');
