...
<main class="app-content">
	...
	<div class="col-md-12">
		<div class="col-md-12">
			<div class="tile">
				<h3 class="tile-title">Tag a Group of Faculty</h3>
							...
							<div class="tile-footer">
								<div class="row">
									<div class="col-md-8 col-md-offset-3">
										<button class="btn btn-primary" type="button"  onclick="ExportToTable()" name="add_subjectDetail" id="add"><i class="fa fa-fw fa-lg fa-check-circle"></i>Save</button>&nbsp;&nbsp;&nbsp;<a class="btn btn-secondary" href="Faculty.php"><i class="fa fa-fw fa-lg fa-arrow-circle-o-left"></i>Back</a>&nbsp;&nbsp;&nbsp;
									</div>
									...
									sheet_name_list.forEach(function (y) { 
											...
											if (exceljson.length > 0 && cnt == 0) {    
												exceljson.forEach(element => {
													$.ajax({
														type: 'POST',
														url: '../function/processFaculty.php',
														data: {faculty: JSON.stringify(element)},
														dataType: 'json'
												})
												.done( function( data ) {
														console.log('done');
